            ...
            <v-data-table :hover="true" :items="data" :headers="columns" :search="search_data" :loading="loading_data_table"
                ...
                <template v-slot:item.actions="{ item }">
                    <div style="min-width: 150px;">
                        <v-btn @click="editForm(item)" class="ma-1" color="success">
                            <v-icon icon="mdi-pencil"></v-icon>
                        </v-btn>
                        <v-btn @click="openDeleteData(item)" class="ma-1" color="red">
        ...
        <v-card class="animate__animated animate__slideInDown pa-5"  elevation="24">
            ...
            <v-card-actions>
                <div class="d-flex justify-center" style="width: 100%;">
                    ...
                    <v-btn color="amber-darken-3 " variant="elevated" class="ma-1" @click="confirmDeleteData()">
